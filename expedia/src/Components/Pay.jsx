...
import {Secpay} from '../Components/Sec_payment'
 ...
 const Pay = () => {
  ...
  return (
    <>
<div>
       <div className={`${styles.nv}`} style={{marginBottom:"15px"}}>
         <div>  <img src="https://www.expedia.co.in/_dms/header/logo.svg?locale=en_GB&siteid=27" alt="" style={{width: "100px",marginTop:"10px"}} /> </div>
     ...
     <div style={{border :"2px solid WHITE" , marginLeft :"5%" , height :"500px" , width:"70%",boxShadow: "rgba(0, 0, 0, 0.25) 0px 54px 55px, rgba(0, 0, 0, 0.12) 0px -12px 30px, rgba(0, 0, 0, 0.12) 0px 4px 6px, rgba(0, 0, 0, 0.17) 0px 12px 13px, rgba(0, 0, 0, 0.09) 0px -3px 5px"}}>
         <span><h2 style={{textAlign:"left" ,marginTop:"-10px"}}>Review and book</h2></span>
      <div style={{display : "flex"   ,  backgroundColor: "#f2f2f2"} }>
        ...
        <h5 style={{border :"1px solid #f2f2f2",marginLeft :"4%" ,marginTop:"0%" }}>Free cancellation before Sat, 21 May, 18:00 (property local time)</h5>
         <p style={{border :"1px solid #f2f2f2",marginLeft :"4%" ,marginTop:"1%", width :"120%"}}>You can change or cancel this stay for a full refund if plans change. Because flexibility matters.</p>
         </div>
