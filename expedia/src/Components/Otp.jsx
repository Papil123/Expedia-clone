...
<body>
    ...
    <div id="otp_card">
        ...
        <div id="number_tab">
            ...
            <input id="ps_1"
            type="password" maxlength="1" style="width: 25px;height: 25px;border-radius: 1px;text-align: center;">
            <input id="ps_2"
             type="password" maxlength="1" style="width: 25px;height: 25px;border-radius: 1px;text-align: center;">
            <input id="ps_3"
            type="password" maxlength="1" style="width: 25px;height: 25px;border-radius: 1px;text-align: center;">
...
<form>
<input type="submit" value="Pay Now" style="margin-left: 40%; margin-top: 12%;" >
</form>
    </div>
